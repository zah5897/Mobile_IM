...
public class ProtocalFactory {
    ...
    public static Protocal createEchoData(String dataContent, String from_user_id
            , boolean QoS, String fingerPrint) {
        return new Protocal(ProtocalType.C.FROM_CLIENT_TYPE_OF_ECHO
                , dataContent, from_user_id, "0", QoS, fingerPrint, 0);
    }
